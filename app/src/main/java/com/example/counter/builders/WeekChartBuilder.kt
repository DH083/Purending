package com.example.counter.builders
...
class WeekChart private constructor(
    ...
    data class WeekChartBuilder(
        ...
        fun setMaxStep(maxStep: Float) = apply {
            ...
            barChart.setBackgroundColor(ContextCompat.getColor(baseContext, R.color.btn))
        ...
        fun setWeek(week: com.example.counter.Model.Week) = apply {
            this.myWeek = week
            ...
            barDataSet.color = ContextCompat.getColor(baseContext, R.color.back)
