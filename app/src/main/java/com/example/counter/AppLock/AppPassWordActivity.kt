...
import com.example.counter.TitleActivity
...
class AppPassWordActivity : AppCompatActivity(){
    ...
    private val btnListener = View.OnClickListener { view ->
        ...
        val etPasscode1 = findViewById<EditText>(R.id.etPasscode1)
        val etPasscode2 = findViewById<EditText>(R.id.etPasscode2)
        val etPasscode3 = findViewById<EditText>(R.id.etPasscode3)
        val etPasscode4 = findViewById<EditText>(R.id.etPasscode4)
    ...
    private fun inputType(type : Int){
        ...
        val etInputInfo = findViewById<TextView>(R.id.etInputInfo)
